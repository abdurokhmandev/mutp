      ...
      navAuth.innerHTML = `
        <div style="display: flex; align-items: center; gap: 12px;">
          ...
          <div class="user-dropdown-container" style="position: relative;">
            <div class="user-avatar-btn" onclick="toggleUserDropdown()" style="width: 40px; height: 40px; border-radius: 50%; background: var(--duo-green-bg); color: var(--duo-green); border: 2px solid var(--duo-green); display: flex; align-items: center; justify-content: center; font-weight: bold; cursor: pointer; font-size: 15px; user-select: none; overflow: hidden;">
              ${user.avatar ? `<img src="${this.getMediaUrl(user.avatar)}" style="width:100%;height:100%;object-fit:cover;">` : this.initials(user.full_name)}
            </div>
